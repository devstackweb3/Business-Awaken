...
const AccordionService = (props: any) => {
    ...
    <div className="list flex flex-col">
      ...
      >
        <div>
          ...
          >
            <div className="w-2/3 bg-gradient-to-r from-white via-white to-gray-400 py-4 inline-block text-transparent bg-clip-text font-semibold text-xl md:text-3xl tracking-[1px]">
              {item.title}
            </div>
            <div className="flex justify-end">
              <div className="text-white py-4 text-xs flex items-end">
                {item.time}
              </div>
              <div className="h-6 w-6 self-center">
                <Image
                  src="/hourglass-waiting.gif"
                  width={300}
                  height={300}
                  alt="Time Needed"
                />
