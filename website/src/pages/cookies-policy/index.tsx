...
const index = () => {
  return (
    <div className="flex flex-col">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to W3B Economy LLC, Delaware.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to W3B Economy, accessible from{' '}
            <a
              href="https://w3beconomy.uk/"
      ...
      <ul>
        <li>By email: contact@w3beconomy.uk</li>
      </ul>
    </div>
  )
}
